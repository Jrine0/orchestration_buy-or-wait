...
| request_05 | 1168.79 / 737 **x** | ok | ok | ok | ok | ok |
| request_06 | 523.84 / 603.3 **x** | **x** | **x** | **x** | ok | **x** |
| request_07 | 86237.21 / 87170.56 ok | ok | ok | ok | **x** | ok |
| request_08 | 285.2 / 284.57 ok | ok | ok | ok | ok | ok |
| request_09 | 166.61 / 166.61 ok | ok | ok | ok | ok | ok |
| request_10 | 32526.82 / 12700 **x** | ok | ok | ok | ok | ok |
| request_11 | 12319866.62 / 12510645 ok | ok | ok | ok | **x** | **x** |
| request_12 | 65164 / 65164 ok | ok | ok | ok | ok | ok |
| request_13 | 490.8 / 433.4 **x** | ok | ok | ok | ok | ok |
| request_14 | 616.29 / 597.74 **x** | ok | ok | ok | ok | ok |
| request_15 | 5.09 / 83.05 **x** | ok | ok | ok | ok | ok |
...
- amount_safe_to_pay: 9/25
- affordability_status: 23/25
- recommended_payment_method: 24/25
- payment_plan: 23/25
- earliest_date_for_full_payment: 21/25
- spending_changes_needed: 22/25
- amount_safe_to_pay exact to the cent: 4/25
- fallback rows: 0
...
- request_05: first mismatch `amount_safe_to_pay` — ours `1168.79` vs truth `737`
...
- request_10: first mismatch `amount_safe_to_pay` — ours `32526.82` vs truth `12700`
...
- request_13: first mismatch `amount_safe_to_pay` — ours `490.8` vs truth `433.4`
- request_14: first mismatch `amount_safe_to_pay` — ours `616.29` vs truth `597.74`
- request_15: first mismatch `amount_safe_to_pay` — ours `5.09` vs truth `83.05`
